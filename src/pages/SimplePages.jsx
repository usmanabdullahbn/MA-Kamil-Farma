    ...
    <div className="simple-page">
      ...
      <div className="container simple-body">
        {[
          ...
          { icon:'🧪', title:'Pharma & Nutra Companies', color:'var(--gold-dark)', desc:'Pharmaceutical and nutraceutical manufacturers require high-purity excipients and raw materials with full documentation. Our Pharma & Nutra division supplies amino acids, vitamins, and specialty excipients meeting international quality standards.', products:['L-Lysine HCl 98.5%', 'DL-Methionine 99%', 'Vitamin A Acetate', 'Choline Chloride 60%'], focus:'Amino Acids · Vitamins · Mineral Salts · Excipients' },
        ...
        <div className="contact-grid">
          ...
          <div className="contact-info">
            ...
            <div className="distributor-map">
              <h3>Distribution Regions</h3>
              {[
                { region:'Pakistan', detail:'Nationwide — Karachi, Lahore, Faisalabad, Multan, Peshawar' },
                { region:'GCC', detail:'UAE, Saudi Arabia, Kuwait, Qatar' },
                { region:'Africa', detail:'Kenya, Nigeria, Tanzania, Ethiopia' },
                { region:'UK', detail:'Distributor enquiries welcome' },
              ].map(r => (
                <div key={r.region} className="dist-region">
                  <span className="dist-region__name">{r.region}</span>
                  <span className="dist-region__detail">{r.detail}</span>
                </div>
              ))}
            </div>
          </div>

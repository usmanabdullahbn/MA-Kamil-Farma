      ...
      <div className="footer__main">
        <div className="container footer__grid">
          ...
          <div className="footer__col">
            ...
            <div className="footer__distributor">
              <div className="footer__dist-title">Distribution Regions</div>
              <div className="footer__dist-tags">
                {['Pakistan', 'GCC', 'Africa', 'UK'].map(r => <span key={r}>{r}</span>)}
              </div>
            </div>
          </div>
        </div>
